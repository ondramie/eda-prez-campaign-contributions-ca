...
net.contbr <- data.frame(net.contbr)
...
# groups occupation column into four groups
###############################################################################
create_job_column <- function(data,col) {
            ...
            data_col <- gsub('^\\s*$', "N/A", data_col, ignore.case = TRUE)
...
pres_df.clean$job <- create_job_column(pres_df.clean, "contbr_occupation")
net.contbr$job <- create_job_column(net.contbr,"contbr_occupation")  
#############################################################################
